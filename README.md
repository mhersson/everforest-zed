...
The theme is generated from `build.js`. To make changes:

1. Edit `build.js` (colors, syntax rules, UI styles)
2. Run `node build.js` to regenerate the theme
3. Reload the extension in Zed to see changes
